...
public class Constants {
	...
	public static final String DEFAULT_DICT = ".Hextractor/EngDict.txt";

	/** The Constant FILE_TYPE_EXTENSIONS. */
	public static final java.util.Map<String, List<String>> FILE_TYPE_EXTENSIONS = Collections.unmodifiableMap(new HashMap<String, List<String>>() {{
		put(FILE_TYPE_MEGADRIVE, Collections.unmodifiableList(Arrays.asList("smd", "gen", "bin", "md", "32x")));
		put(FILE_TYPE_SNES, Collections.unmodifiableList(Arrays.asList("sfc", "smc")));
		put(FILE_TYPE_NGB, Collections.unmodifiableList(Arrays.asList("gb", "gbc")));
		put(FILE_TYPE_ZXTAP, Collections.singletonList("tap"));
		put(FILE_TYPE_TZX, Collections.unmodifiableList(Arrays.asList("tzx", "cdt")));
		put(FILE_TYPE_MASTERSYSTEM, Collections.singletonList("sms"));
	}});
