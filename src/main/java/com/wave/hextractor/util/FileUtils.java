...
public class FileUtils {
     ...
     * Agrupa los cambios permitiendo hasta 5 bytes sin cambios dentro de un mismo rango.
     ...
     */
    public static void extractDiffAsExt(File originalFile, File modFile, File outExtFile) throws IOException {
