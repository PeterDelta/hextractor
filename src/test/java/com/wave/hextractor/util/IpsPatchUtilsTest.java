...
public class IpsPatchUtilsTest {
    ...
    public void createIpsPatch() throws IOException, NoSuchAlgorithmException {
        ...
        assertTrue(IpsPatchUtils.createIpsPatch(file1.getAbsolutePath(), file2.getAbsolutePath(), file3.getAbsolutePath()));
    }
    ...
    public void applyIpsPatch() throws IOException, NoSuchAlgorithmException {
        ...
        assertArrayEquals(Files.readAllBytes(file2.toPath()), Files.readAllBytes(file4.toPath()));
    }
    ...
    public void validateIpsPatch() throws IOException {
        ...
        file3.deleteOnExit();
        assertTrue(IpsPatchUtils.createIpsPatch(file1.getAbsolutePath(), file2.getAbsolutePath(), file3.getAbsolutePath()));
        assertTrue(IpsPatchUtils.validateIpsPatch(file1.getAbsolutePath(), file2.getAbsolutePath(), file3.getAbsolutePath()));
    }
